        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p class="mb-4">
                    Parstravel, a beacon in the realm of wanderlust, offers an unparalleled journey through the tapestry of destinations across the globe. Established on the principles of passion, precision, and personalized service, Parstravel has redefined the essence of travel.</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        ...
                        <div class="text-center p-4">
                            <h5 class="mb-0">Daniel Willson</h5>
