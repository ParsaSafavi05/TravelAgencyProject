        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    <a onclick=changeTab(home) id="home" href="../home/index" class="nav-item nav-link active">Users</a>
                    <a onclick=changeTab(about) id="about" href="../aboutus/index" class="nav-item nav-link">Packages</a>
                    <a onclick=changeTab(contact) id="contact" href="../contact/index" class="nav-item nav-link">Bookings</a>
