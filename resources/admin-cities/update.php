				...
				<div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="text" class="form-control bg-white text-dark" placeholder="City Name" id="city_name" name="city_name" value="'.$cities[0]->city_name.'">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <select class="form-select bg-white text-dark" id="country" name="country">
                                <option selected value="'.$cities[0]->country_id.'">'.$cities[0]->country_name.'</option>';
